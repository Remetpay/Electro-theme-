...
This repository is now structured as a Shopify theme that can be connected/imported from GitHub into Shopify. It uses Liquid, JSON templates, Shopify product forms, collection data, cart data, and theme sections.
...
- `config/settings_schema.json` — theme metadata/settings.
...
- Test product add-to-cart, dynamic checkout, cart drawer, cart page, mobile navigation, and checkout before publishing.
